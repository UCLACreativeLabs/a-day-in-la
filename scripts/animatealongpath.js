...
// get to the next milestone, converts a value between [0,1] to the corresponding path
// length it should reach
function makeTravelInterpolator(milestones) {
	var index = 0,
		prevLength = 0,
...
function animateAlongPath(path, el, start, duration, milestones, animObj, easing, callback) {
	...
	var getLength = makeTravelInterpolator(milestones);
